...
print()
redirect_url = input("Redirect URL after Internet connection is established [default: None]: ")
os.system('clear')
print()
print()
...
if(install_ans.lower() == 'y'):
	...
	setup_lib.update_main_config_file(entered_ssid, auto_config_choice, auto_config_delay, ssl_enabled_choice, server_port_choice, redirect_url)
else:
	print()
	print()
	print("===================================================")
